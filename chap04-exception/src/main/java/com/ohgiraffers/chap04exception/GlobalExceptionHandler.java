...
@ControllerAdvice   // Exception 이 발생 했을 때 핸들링 해주는 클래스를 만드는 어노테이션
public class GlobalExceptionHandler {
    // 지역 Exception 처리가 우선권을 가진다.
    // 1순위 try/catch 없으면 2순위 지역 Exception 처리   도 없으면 3순위 Global Exception 처리(바로 여기)
